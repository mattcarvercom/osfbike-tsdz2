...
async function createSdasstm8Module(moduleArg = {}) {
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('sdasstm8.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('sdasstm8.wasm', import.meta.url).href;
...
export default createSdasstm8Module;
