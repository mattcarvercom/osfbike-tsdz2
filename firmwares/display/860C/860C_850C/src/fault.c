...
void HardFault_Handler(void){
        ...
        // Trailing ".syntax" is sticky for the rest of the translation unit's assembly -
        // leaving it at "divided" here broke GCC's own auto-generated epilogue for the
        // next function. Left at "unified" instead (see 860C_FROM_SOURCE_BUILD.md).
