...
*/
  ...
  .ui8_active_theme_index = DEFAULT_VALUE_ACTIVE_THEME_INDEX,
  .ui8_temp_min_warn_offset = DEFAULT_VALUE_TEMP_MIN_WARN_OFFSET,
  .ui8_temp_max_warn_offset = DEFAULT_VALUE_TEMP_MAX_WARN_OFFSET,
  .ui8_temp_max_crit_offset = DEFAULT_VALUE_TEMP_MAX_CRIT_OFFSET,
  .ui8_display_temp_icon_enabled = DEFAULT_VALUE_DISPLAY_TEMP_ICON_ENABLED,
  .ui8_display_temp_value_enabled = DEFAULT_VALUE_DISPLAY_TEMP_VALUE_ENABLED,
  .ui8_mini_card_1_field = DEFAULT_VALUE_MINI_CARD_1_FIELD,
  .ui8_mini_card_2_field = DEFAULT_VALUE_MINI_CARD_2_FIELD,
  .ui8_mini_graph_field = DEFAULT_VALUE_MINI_GRAPH_FIELD,
  .ui8_human_power_bar_scale = DEFAULT_VALUE_HUMAN_POWER_BAR_SCALE,
  .ui8_motor_power_bar_scale = DEFAULT_VALUE_MOTOR_POWER_BAR_SCALE,
  .ui8_battery_field_enable = DEFAULT_VALUE_BATTERY_FIELD_ENABLE,
...
//#ifndef SW102
		  ...
		  case EEPROM_0x52_VERSION:
			m_eeprom_data.ui8_active_theme_index = DEFAULT_VALUE_ACTIVE_THEME_INDEX;
			
		  case EEPROM_0x53_VERSION:
			m_eeprom_data.ui8_temp_min_warn_offset = DEFAULT_VALUE_TEMP_MIN_WARN_OFFSET;
			m_eeprom_data.ui8_temp_max_warn_offset = DEFAULT_VALUE_TEMP_MAX_WARN_OFFSET;
			m_eeprom_data.ui8_temp_max_crit_offset = DEFAULT_VALUE_TEMP_MAX_CRIT_OFFSET;
			m_eeprom_data.ui8_display_temp_icon_enabled = DEFAULT_VALUE_DISPLAY_TEMP_ICON_ENABLED;
			m_eeprom_data.ui8_display_temp_value_enabled = DEFAULT_VALUE_DISPLAY_TEMP_VALUE_ENABLED;
			
		  case EEPROM_0x54_VERSION:
			m_eeprom_data.ui8_mini_card_1_field = DEFAULT_VALUE_MINI_CARD_1_FIELD;
			m_eeprom_data.ui8_mini_card_2_field = DEFAULT_VALUE_MINI_CARD_2_FIELD;
			m_eeprom_data.ui8_mini_graph_field = DEFAULT_VALUE_MINI_GRAPH_FIELD;

		  case EEPROM_0x55_VERSION:
			m_eeprom_data.ui8_human_power_bar_scale = DEFAULT_VALUE_HUMAN_POWER_BAR_SCALE;
			m_eeprom_data.ui8_motor_power_bar_scale = DEFAULT_VALUE_MOTOR_POWER_BAR_SCALE;

		  case EEPROM_0x56_VERSION:
			m_eeprom_data.ui8_battery_field_enable = DEFAULT_VALUE_BATTERY_FIELD_ENABLE;
...
void eeprom_init_variables(void) {
  ...
  ui_vars->ui8_active_theme_index = m_eeprom_data.ui8_active_theme_index;

  ui_vars->ui8_temp_min_warn_offset = m_eeprom_data.ui8_temp_min_warn_offset;
  ui_vars->ui8_display_temp_icon_enabled = m_eeprom_data.ui8_display_temp_icon_enabled;
  ui_vars->ui8_display_temp_value_enabled = m_eeprom_data.ui8_display_temp_value_enabled;

  ui_vars->ui8_mini_card_1_field = m_eeprom_data.ui8_mini_card_1_field;
  ui_vars->ui8_mini_card_2_field = m_eeprom_data.ui8_mini_card_2_field;
  ui_vars->ui8_mini_graph_field = m_eeprom_data.ui8_mini_graph_field;

  ui_vars->ui8_human_power_bar_scale = m_eeprom_data.ui8_human_power_bar_scale;
  ui_vars->ui8_motor_power_bar_scale = m_eeprom_data.ui8_motor_power_bar_scale;

  ui_vars->ui8_battery_field_enable = m_eeprom_data.ui8_battery_field_enable;
}
...
void eeprom_write_variables(void) {
  ...
  m_eeprom_data.ui8_active_theme_index = ui_vars->ui8_active_theme_index;

  m_eeprom_data.ui8_temp_min_warn_offset = ui_vars->ui8_temp_min_warn_offset;
  m_eeprom_data.ui8_display_temp_icon_enabled = ui_vars->ui8_display_temp_icon_enabled;
  m_eeprom_data.ui8_display_temp_value_enabled = ui_vars->ui8_display_temp_value_enabled;

  m_eeprom_data.ui8_mini_card_1_field = ui_vars->ui8_mini_card_1_field;
  m_eeprom_data.ui8_mini_card_2_field = ui_vars->ui8_mini_card_2_field;
  m_eeprom_data.ui8_mini_graph_field = ui_vars->ui8_mini_graph_field;

  m_eeprom_data.ui8_human_power_bar_scale = ui_vars->ui8_human_power_bar_scale;
  m_eeprom_data.ui8_motor_power_bar_scale = ui_vars->ui8_motor_power_bar_scale;

  m_eeprom_data.ui8_battery_field_enable = ui_vars->ui8_battery_field_enable;
