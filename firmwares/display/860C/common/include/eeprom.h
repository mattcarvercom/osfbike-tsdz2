...
#define EEPROM_0x52_VERSION 0x52
#define EEPROM_0x53_VERSION 0x53
#define EEPROM_0x54_VERSION 0x54
#define EEPROM_0x55_VERSION 0x55
#define EEPROM_0x56_VERSION 0x56
...
// EEPROM_0x54_VERSION
	// Temperature icon/color feedback thresholds. Signed byte offsets from the
	// motor's temperature limits (negative by default - "warn 10 degrees below
	// min"). Named ui8_ to match this codebase's "byte-sized field" convention
	// even though they are int8_t.
	int8_t ui8_temp_min_warn_offset;
	int8_t ui8_temp_max_warn_offset;
	int8_t ui8_temp_max_crit_offset;
...
#define DEFAULT_VALUE_UNITS_TYPE                                    1 // // 0=km/h, 1=miles
#ifndef SW102
...
#define DEFAULT_VALUE_ACTIVE_THEME_INDEX                             0
...
#define DEFAULT_VALUE_MINI_CARD_1_FIELD                             0
#define DEFAULT_VALUE_MINI_CARD_2_FIELD                             1
#define DEFAULT_VALUE_MINI_GRAPH_FIELD                              0

// Index into POWER_BAR_SCALE[] (theme_osf_modern.c) - 0 = "1x"/no scaling.
#define DEFAULT_VALUE_HUMAN_POWER_BAR_SCALE                         0
#define DEFAULT_VALUE_MOTOR_POWER_BAR_SCALE                         9 // "1x" - index 9 after 0.1x-0.9x reorder

// 0=percentage, 1=disabled, 2=battery voltage - see ui8_battery_field_enable
#define DEFAULT_VALUE_BATTERY_FIELD_ENABLE                          0
