 ...
 *
 * Verified (2026-08-20) byte-for-byte identical to the CRC16 used by the
 * reference implementation (emmebrusa/TSDZ2-Smart-EBike-860C, src/common.c)
 * that firmwares/display/860C/ pairs with: same polynomial (0xA001), same
 * initial value (0xFFFF), same bit order. This is the CRC the 860C/850C
 * protocol (ENABLE_860C_LVGL_UART) relies on.
 */
