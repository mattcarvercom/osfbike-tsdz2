...
void EEPROM_controller(uint8_t ui8_operation, uint8_t ui8_byte_init)
{
  ...
  switch (ui8_operation)
  {
    ...
    case READ_FROM_MEMORY:
      ...
      ui8_eeprom_temp = FLASH_ReadByte(ADDRESS_BATTERY_LOW_VOLTAGE_CUT_OFF_X10_1);
      ui16_temp += (((uint16_t) ui8_eeprom_temp << 8) & 0xff00);
      ...
      ui8_eeprom_temp = FLASH_ReadByte(ADDRESS_WHEEL_PERIMETER_1);
      ui16_temp += (((uint16_t) ui8_eeprom_temp << 8) & 0xff00);
